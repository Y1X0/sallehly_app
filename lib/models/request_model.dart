class RequestModel {
  ...
  // تُترجم أو تُستبدل هذه الحرفيات أبداً ضمن ترحيل الإنجليزية — ذلك سيكسر كل
  // منطق الحالة هنا فوراً بغض النظر عن لغة الواجهة المعروضة. الإصلاح الصحيح
  // (تعداد RequestStatus + fromWire() + جدول تسميات مترجم لعرضه فقط في
  // request_status_chip.dart) مؤجَّل عمداً لمرحلة منفصلة لاحقة (راجع
  // L10N_PROGRESS.md §4) بعد انتهاء ترحيل كل النصوص الثابتة العادية أولاً.
